...
// Get the API URL from environment variables or fallback to live Render backend
const API_BASE_URL = process.env.REACT_APP_API_URL || 'https://fintrack-pro-yhxl.onrender.com/api';
